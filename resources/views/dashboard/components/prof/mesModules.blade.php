                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card text-center mb-3">
                            <div class="card-body">
                                ...
                                <h5 class="card-text"><span>{{ $module->historiques->sum('total_heure') }}</span>h sur
                                    <span>{{ $module->heure_globale }}</span></h5>
                                <a href="{{ route('historique.liste', ['id' => $module->id]) }}"
                                    class="btn btn-secondary">Historiques</a>
                                @if ($module->historiques->sum('total_heure') >= $module->heure_globale)
                                    <p class="text-success">Vous avez fini</p>
                                @else
