...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Enregistrement</h4>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{ route('historique.saisie', ['id' => $module_id]) }}" method="POST">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="time" class="form-control" name="heure_de_fin" id="input-end-time"
                                        aria-label="Heure de Fin" />
                                    <input type="hidden" class="form-control" name="module_id"
                                        value="{{ e($module_id) }}" />
                                </div>
